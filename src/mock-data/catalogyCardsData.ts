export const catalogyCardsData = [
	{
		...
		status: "Нове",
		price: "1200 UAH",
		description: "Ця ніжна та елегантна сукня ідеально підходить для літніх днів. Виготовлена з легкого та дихаючого матеріалу, вона забезпечує комфорт протягом всього дня. Сукня виконана у білому кольорі з яскравим блакитним квітковим принтом, що додає образу свіжості та романтичності. ",
		timestamp: "Вчора 21:30",
		cityName: "Київ",
