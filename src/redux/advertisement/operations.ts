...
export const getTopSubCategory = createAsyncThunk('advert/getTopSubCategory', async (categoryId, thunkAPI) => {
    try {
...
export const getLowSubCategory = createAsyncThunk('advert/getLowSubCategory', async (subcategoryId, thunkAPI) => {
    try {
