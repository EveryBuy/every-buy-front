...
//   <div className={styles.buyButton}>{children}</div>
// );
// const SellButton = ({ children }) => (
//   <div className={styles.sellButton}>{children}</div>
// );
...
//   <div className={styles.listItemWrapper}>{children}</div>
// );
// const ListItemImage = ({ src, alt, width, height }) => (
//   <img
